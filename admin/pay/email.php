<?php 
	function send_email($email_recive,$name,$contents,$subject){
        ...
        require "../vendorphpmailer/class.phpmailer.php";
        ...
        $mail->Username   = "khanhnet2632000@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "khanhnet"; //Mật khẩu của gmail
        $mail->SetFrom("khanhnet2632000@gmail.com", "god"); // Thông tin người gửi
        $mail->AddReplyTo("khanhnet2632000@gmail.com","god");// Ấn định email sẽ nhận khi người dùng reply lại.
