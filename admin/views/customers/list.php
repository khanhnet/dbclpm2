 ...
 <div class="container " >
  ...
  foreach ($data as $row) {
     ...
     <tr>
        ...
        <a href="?mod=customer&act=edit&CODE=<?= $row['CODE'] ?>" class="btn btn-warning">Sửa</a>  
        <a href="?mod=customer&act=delete&CODE=<?= $row['CODE'] ?>" class="btn btn-danger btn-delete">Xóa</a> </td> 
     </tr>
 <?php } ?>
  </tbody>
</table>    
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h2 class="modal-title text-center" id="exampleModalLabel">Chi tiết khách hàng</h2>
              ...
              <div class="modal-body">
                <div class="card" >
                  ...
                  <div class="card-body">
                    <p >Mã khách hàng : <span id="code_show"></span></p>
                    <p >Tên khách hàng : <span id="name_show"></span></p>
 ...
 ?>
  <script type="text/javascript">
      ...
      $.ajax({
        type: 'get',
        dataType: 'json',
        url: '?mod=customer&act=detail&CODE='+id,
