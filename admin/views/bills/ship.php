...
<form action="?mod=bill&act=timeShip&CODE=<?=$CODE ?>" method="POST" role="form">
  
 
   <div class="form-group">
     <label for="">Chọn ngày giao hàng</label>
     <input type="date" class="form-control" id="" name="TIME_SHIP">
   </div>
