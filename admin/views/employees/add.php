...
<div class="container bootstrap snippet">
  ...
  <div><h1>Thêm mới nhân viên</h1></div>
          ...
          <form action="?mod=employee&act=store" method="POST" role="form" " enctype="multipart/form-data" class="formValidate">
  <div class="row">

    <div class="col-sm-3">
      <div class="text-center">
        <img src="public/images/employees/profile.png" class="avatar img-circle img-thumbnail" alt="avatar">
