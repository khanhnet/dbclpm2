...
<div class="container bootstrap snippet">
  ...
  <div><h1>Cập nhật thông tin nhân viên</h1></div>

          <form action="?mod=employee&act=update&CODE=<?= $details['CODE']?>"" method="POST" role="form" " enctype="multipart/form-data"  class='formValidate'>
  <div class="row">

    <div class="col-sm-3">
      <div class="text-center">
        <img src="public/images/employees/<?= $details['PICTURE']?>" class="avatar img-circle img-thumbnail" alt="avatar">
