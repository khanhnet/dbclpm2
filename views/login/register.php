...
<div class="main-div">
   ...
   <p>Vui lòng nhập thông tin</p>
    ...
    <form id="Login"  action="?mod=customer&act=store" method="post">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control"  name="DATE" placeholder="Nhập vào ngày sinh">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control"  name="MOBILE" placeholder="Nhập số điện thoại">
        ...
        <a href="?mod=login&act=login" class="btn btn-success my-2">Đăng nhập</a>
        <div class="forgot">
