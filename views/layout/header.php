				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="?mod=product&act=list" style="font-family: 'Akronim', cursive;font-size: 3rem">Netherrealm</a></div>
							<nav class="main_nav">
								<ul>
									...
									<li class="hassubs">
                    					...
                    					if (substr($value['CATEGORY_CODE'],0,3)=='LSP') {
                  						 ?>
                   				 <li><a href="?mod=product&act=list&CATEGORY=<?=$value['CATEGORY_CODE'] ?>"><?=$value['CATEGORY_NAME']?></a></li>                
               				 <?php  } } ?>
									...
									<li><a href="?mod=customer&act=contact">Liên hệ</a></li>

								<?php if (isset($_SESSION['user']['PASSWORD'])) {
									
								 ?>
									<li><a href="?mod=customer&act=detail&CODE=<?=$_SESSION['user']['CODE'] ?>"><?=$_SESSION['user']['NAME'] ?></a></li>
								<?php 
							}else{
								 ?>
								 <li><a href="?mod=login&act=login">Tài khoản</a></li>
								<?php } ?>
								</ul>
							</nav>
							<div class="header_extra ml-auto">
								<div class="shopping_cart">
									<a href="?mod=sale&act=cart">
										...
										<div>Giỏ hàng <span class="badge badge-success">
											<?php
